...
ifeq ($(CHANNEL),prod)
	CORE_URL=https://hub.gitmirror.com/github.com/hiddify/hiddify-next-core/releases/download/v$(core.version)
else
	CORE_URL=https://hub.gitmirror.com/github.com/hiddify/hiddify-next-core/releases/download/draft
endif
